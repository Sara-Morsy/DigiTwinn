...
graph TD
  ...
  OT_IoT_System_Integration["OT/IoT System Integration"]
  Data_storage["Data storage"]
  API_services["API services"]
  Scientific_Domain["Scientific Domain"]
  Edge_AI___Intelligence["Edge AI & Intelligence"]
  ...
  Alerts___Notifications["Alerts & Notifications"]
  Entity_relationship_visualization["Entity relationship visualization"]
  AI_model_repository["AI model repository"]
  ...
  Distributed_Ledger___Smart_Contracts["Distributed Ledger & Smart Contracts"]
  Model_performance_metrics["Model performance metrics"]
  OT_IoT_system_integration["OT/IoT system integration"]
  ...
  Data_integration["Data integration"]
  Digital_Twin__DT__Model_Repository["Digital Twin (DT) Model Repository"]
  Use_case["Use case"]
  ...
  I_O_performance_metrics["I/O performance metrics"]
  ...
  Paper_DOI -- "Mentions" --> Real_time_Processing
  ...
  Paper_DOI -- "Mentions" --> Alerts___Notifications
  Paper_DOI -- "Mentions" --> Analytical_model
  Paper_DOI -- "Mentions" --> Cloud_node
  Paper_DOI -- "Mentions" --> Compute_resources_for_data_analysis
  Paper_DOI -- "Mentions" --> Distributed_Ledger___Smart_Contracts
  Paper_DOI -- "Mentions" --> Edge_AI___Intelligence
  ...
  Paper_DOI -- "Mentions" --> I_O_performance_metrics
  ...
  Paper_DOI -- "Mentions" --> Real_time_Monitoring
  ...
  AI_model_repository -- "hosts" --> Edge_AI___Intelligence
  ...
  Archive_services -- "supports" --> Digital_Twin__DT__Model_Repository
  ...
  Collaboration_platform_integration -- "coordinates" --> Distributed_Ledger___Smart_Contracts
  Compliance_indicator -- "describes" --> Paper_Title
  Compute_resources_for_data_analysis -- "used_by" --> Analytical_model
  Compute_resources_for_data_analysis -- "evaluated_by" --> I_O_performance_metrics
  Dashboards -- "enhanced_by" --> 3D_Rendering
  Dashboards -- "display" --> Advanced_visualization
  Dashboards -- "display" --> Alerts___Notifications
  ...
  Data_archive_services -- "supports" --> Digital_Twin__DT__Model_Repository
  ...
  Data_processing -- "includes" --> Real_time_Processing
  ...
  Data_storage -- "supports" --> Digital_Twin__DT__Model_Repository
  ...
  Digital_twin_federation -- "integrates" --> OT_IoT_System_Integration
  ...
  Edge_AI___Intelligence -- "enabled_by" --> API_services
  Edge_AI___Intelligence -- "enables" --> Prediction
  ...
  OT_IoT_system_integration -- "connected_to" --> Enterprise_System_Integration
  ...
  Real_time_Monitoring -- "drives" --> Dashboards
  ...
  Temporal_data_store -- "supports" --> Real_time_Monitoring
